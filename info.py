...
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/HOWTO61")   # Third tutorial link for verification
...
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/+pBgHUoaowsxhZmZl') # Update channel link for the bot
